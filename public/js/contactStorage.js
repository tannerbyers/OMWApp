...
function fetchContacts() {
    ...
    for (var i = 0; i < Contacts.length; i++) {
        ...
        ContactsResults.innerHTML += `<div class="m-2 btn btn-light"><h3 onclick="inputcontactphone('${PhoneNumber}')" class="" value="${PhoneNumber}">${Contact}<span class="xbutton" onclick="deleteContact('${PhoneNumber}')">X</span></h3></div>`;
    }
}
